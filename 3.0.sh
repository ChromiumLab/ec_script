...
wget http://llvm.org/releases/3.0/llvm-3.0.src.tar.gz
wget http://llvm.org/releases/3.0/clang-3.0.src.tar.gz
wget http://llvm.org/releases/3.0/compiler-rt-3.0.src.tar.gz

tar zxvf ./llvm-3.0.src.tar.gz
tar zxvf ./clang-3.0.src.tar.gz
tar zxvf ./compiler-rt-3.0.src.tar.gz
